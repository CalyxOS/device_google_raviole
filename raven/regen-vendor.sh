...
VENDOR_SKIP_FILES=(
    ...
    "etc/UWB-calibration-kg.conf"
    "etc/UWB-calibration-kz.conf"
    "etc/UWB-calibration-np.conf"
    "etc/UWB-calibration-pk.conf"
    "etc/UWB-calibration-py.conf"
    "etc/UWB-calibration-ru.conf"
    "etc/UWB-calibration-sb.conf"
    "etc/UWB-calibration-tj.conf"
    "etc/UWB-calibration-tm.conf"
    "etc/UWB-calibration-ua.conf"
    "etc/UWB-calibration-unknown.conf"
    "etc/UWB-calibration-uz.conf"
